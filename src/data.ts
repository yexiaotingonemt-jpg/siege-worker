...
export const MINION_REWARD_DROP_CHANCE=.005;
...
export type EnemyKind='infantry'|'heavy'|'archer'|'cavalry'|'air'|'boss1'|'boss2'|'boss3'|'boss4'|'boss5';
export const ENEMIES:Record<EnemyKind,{name:string;hp:number;armor:number;speed:number;attack:number;interval:number;range:number;wind:number;r:number;gold:number;xp:number;boss?:boolean;cavalry?:boolean;air?:boolean;color:number}>={
 ...
 boss5:{name:'城塞巨像',hp:9000,armor:35,speed:1.5,attack:44,interval:1.8,range:1.1,wind:.7,r:.72,gold:200,xp:300,boss:true,color:0xd96f55}
};
export const WAVES=[ [8,0,0,0,0],[12,0,0,0,0],[14,2,0,0,0],[16,2,3,0,0],[12,2,2,0,0], [17,3,4,0,3],[18,3,4,4,4],[19,4,6,4,5],[22,5,6,6,6],[14,4,6,4,4], [23,6,8,6,7],[24,6,10,8,8],[27,8,10,8,9],[28,8,12,10,10],[18,6,8,8,6], [29,10,12,10,11],[32,10,14,12,12],[35,12,14,14,13],[38,12,16,16,14],[21,8,10,10,9],[18,6,8,8,6] ];
export const TOTAL_WAVES=WAVES.length;
export const NORMAL:EnemyKind[]=['infantry','heavy','archer','cavalry','air'];
export const BOSS_WAVES:Record<number,EnemyKind>={3:'boss1',6:'boss1',9:'boss2',12:'boss2',15:'boss3',18:'boss4',21:'boss5'};
