...
export type EnemyKind='infantry'|'heavy'|'archer'|'cavalry'|'boss1'|'boss2'|'boss3'|'boss4';
export const ENEMIES:Record<EnemyKind,{name:string;hp:number;armor:number;speed:number;attack:number;interval:number;range:number;wind:number;r:number;gold:number;xp:number;boss?:boolean;cavalry?:boolean;color:number}>={
...
export const WAVES=[ [8,0,0,0],[12,0,0,0],[14,2,0,0],[16,2,3,0],[12,2,2,0], [20,3,4,0],[22,3,4,4],[24,4,6,4],[28,5,6,6],[18,4,6,4], [30,6,8,6],[32,6,10,8],[36,8,10,8],[38,8,12,10],[24,6,8,8], [40,10,12,10],[44,10,14,12],[48,12,14,14],[52,12,16,16],[30,8,10,10] ];
export const NORMAL:EnemyKind[]=['infantry','heavy','archer','cavalry'];
